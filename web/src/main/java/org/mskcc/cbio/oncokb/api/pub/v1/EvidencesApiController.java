...
public class EvidencesApiController implements EvidencesApi {
    ...
    public ResponseEntity<List<Evidence>> evidencesLookupGet(
        ...
        , @ApiParam(value = "Separate by comma. LEVEL_1, LEVEL_2, LEVEL_3A, LEVEL_3B, LEVEL_4, LEVEL_R1, LEVEL_R2, LEVEL_R3") @RequestParam(value = "levelOfEvidence", required = false) String levels
