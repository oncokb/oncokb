...
/**
 * @ngdoc service
 * @name oncokbApp.cbioDownloadUtil
 * @description
 * # cbioDownloadUtil
...
/**
 * Modified by Hongxin Zhang accordingly for OncoKB
 */
angular.module('oncokbApp')
  .factory('cbioDownloadUtil', function (cbioUtil) {
      ...
      var _defaultOpts = {
        ...
        postProcess: cbioUtil.b64ToByteArrays // post-process function for the data returned by the server (optional)
      };
      ...
      function requestDownload(servletName, servletParams)
      {
        ...
        initDownloadFrame(function() {
          var targetWindow = cbioUtil.getTargetWindow("global_file_download_frame");
