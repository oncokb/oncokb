    ...
    alter table evidence_tag 
        drop 
        foreign key FK2CCB89B24E1A8BBF;

    alter table evidence_tag 
        drop 
        foreign key FK2CCB89B2F7262935;
    ...
    alter table mutation_type_tag 
        drop 
        foreign key FK5B81DDEBEDEE310B;

    alter table mutation_type_tag 
        drop 
        foreign key FK5B81DDEB4E1A8BBF;

    alter table oncogenicity_tag 
        drop 
        foreign key FK77BAB2EADDB59138;

    alter table oncogenicity_tag 
        drop 
        foreign key FK77BAB2EA4E1A8BBF;
    ...
    drop table if exists evidence_tag;
    ...
    drop table if exists mutation_type_tag;

    drop table if exists oncogenicity;

    drop table if exists oncogenicity_tag;
    ...
    create table mutation_type_tag (
        tag_id integer not null,
        mutation_type_id integer not null,
        primary key (tag_id, mutation_type_id)
    );

    create table oncogenicity (
        id integer not null auto_increment,
        oncogenicity varchar(20),
        primary key (id)
    );

    create table oncogenicity_tag (
        tag_id integer not null,
        oncogenicity_id integer not null,
        primary key (tag_id, oncogenicity_id)
    );
    ...
    alter table evidence_tag 
        add index FK2CCB89B24E1A8BBF (tag_id), 
        add constraint FK2CCB89B24E1A8BBF 
        foreign key (tag_id) 
        references tag (id);

    alter table evidence_tag 
        add index FK2CCB89B2F7262935 (evidence_id), 
        add constraint FK2CCB89B2F7262935 
        foreign key (evidence_id) 
        references evidence (id);
    ...
    alter table mutation_type_tag 
        add index FK5B81DDEBEDEE310B (mutation_type_id), 
        add constraint FK5B81DDEBEDEE310B 
        foreign key (mutation_type_id) 
        references mutation_type (id);

    alter table mutation_type_tag 
        add index FK5B81DDEB4E1A8BBF (tag_id), 
        add constraint FK5B81DDEB4E1A8BBF 
        foreign key (tag_id) 
        references tag (id);

    alter table oncogenicity_tag 
        add index FK77BAB2EADDB59138 (oncogenicity_id), 
        add constraint FK77BAB2EADDB59138 
        foreign key (oncogenicity_id) 
        references oncogenicity (id);

    alter table oncogenicity_tag 
        add index FK77BAB2EA4E1A8BBF (tag_id), 
        add constraint FK77BAB2EA4E1A8BBF 
        foreign key (tag_id) 
        references tag (id);
    ...
    alter table tag 
        add index FK1BF9AC602BC92 (entrez_gene_id), 
        add constraint FK1BF9AC602BC92 
        foreign key (entrez_gene_id) 
        references gene (entrez_gene_id);
