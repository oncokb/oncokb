...
| --- | --- | --- |
| `IndicatorQueryResp.alterationValidationError` | Added (nullable object) | `byProteinChange`, `byHGVSg`, `byGenomicChange` |
| `IndicatorQueryResp.alterationValidationError.type` | Added (enum: `REFERENCE_ALLELE_MISMATCH`, `POSITION_OUT_OF_RANGE`, `REVERSED_POSITION_RANGE`, `MALFORMED_ALTERATION`) | `byProteinChange`, `byHGVSg`, `byGenomicChange` |
| `IndicatorQueryResp.alterationValidationError.message` | Added (the same reason in words) | `byProteinChange`, `byHGVSg`, `byGenomicChange` |
