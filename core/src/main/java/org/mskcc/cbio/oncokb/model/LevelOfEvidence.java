...
public enum LevelOfEvidence {
    LEVEL_1 ("1", "FDA-approved biomarker in approved indication. The alteration is"
            + " used or has been used as an eligibility criterion for clinical"
    ...
    LEVEL_3 ("3", "Clinical evidence linking unapproved biomarker to response."
            + " There is limited clinical evidence (early or conflicting data)"
            + " for an association between this alteration and response/resistance"
            + " to this agent or class of agents."),
