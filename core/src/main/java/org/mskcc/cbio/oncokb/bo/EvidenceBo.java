...
public interface EvidenceBo extends GenericBo<Evidence> {
     ...
     * @return
     */
    EvidenceContainer findEvidencesByAlteration(Collection<Alteration> alterations, Collection<EvidenceType> evidenceTypes, TumorType tumorType, List<TumorType> tumorTypes);
     ...
     * @return
     */
    EvidenceContainer findEvidencesByAlteration(Collection<Alteration> alterations, Collection<EvidenceType> evidenceTypes, TumorType tumorType, List<TumorType> tumorTypes, Collection<LevelOfEvidence> levelOfEvidences);
