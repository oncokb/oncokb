...
public interface EvidenceBo extends GenericBo<Evidence> {
     ...
     * @return
     */
    EvidenceListContainer findEvidencesByAlteration(Collection<Alteration> alterations, Collection<EvidenceType> evidenceTypes, TumorType tumorType, List<TumorType> tumorTypes);
     ...
     * @return
     */
    EvidenceListContainer findEvidencesByAlteration(Collection<Alteration> alterations, Collection<EvidenceType> evidenceTypes, TumorType tumorType, List<TumorType> tumorTypes, Collection<LevelOfEvidence> levelOfEvidences);
