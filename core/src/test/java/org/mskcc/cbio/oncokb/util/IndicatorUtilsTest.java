...
public class IndicatorUtilsTest {
    ...
    public void testProcessQuery() throws Exception {
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CCT8L2-CCT8L2", null, "structural_variant", StructuralVariantType.DELETION, "Pancreatic Adenocarcinoma", null, null, null, null, false, null, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CCT8L2-CCT8L2", null, "structural_variant", StructuralVariantType.DELETION, "Pancreatic Adenocarcinoma", "fusion", null, null, null, false, null, null);
        ;
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("Gene should not exist, but it does.", false, indicatorQueryResp.getGeneExist());
        assertEquals("The oncogenicity is not unknown, but it should.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "MSH2", "", null, null, "CANCER", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The oncogenicity is not unknown, but it should.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());

        // Oncogenic should always match with oncogenic summary, similar to likely oncogenic
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "R248Q", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KRAS", "V14I", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        // Check critical case
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        // Check fusion.
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "CUL1-BRAF Fusion", null, null, "Ovarian Cancer", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF-TMPRSS2", null, "fusion", null, "Prostate Adenocarcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ATM", "ATM-intragenic", null, null, "Ovarian Cancer", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "MEL", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        // check variant exist
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, null, null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertTrue("The variantExist should be true, but it's not", indicatorQueryResp.getVariantExist());
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3CA", "V105_R108delVGNR", null, null, null, null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertTrue("The variantExist should be true, but it's not", indicatorQueryResp.getVariantExist());
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3CA", "V105_R108del", null, null, null, null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertTrue("The variantExist should be true, but it's not", indicatorQueryResp.getVariantExist());
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3CA", "V10000", null, null, null, null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
...
//        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "RET", "Fusions", null, null, "Medullary Thyroid Cancer", null, null, null, null, false, null, null);
//        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null true, null, false);
...
//        assertEquals("The level 3A should be shown before 2A", LevelOfEvidence.LEVEL_3A, indicatorQueryResp.getTreatments().get(0).getLevel());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3R1", "K567E", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KEAP1", "Y525S", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ALK", "R401Q", null, null, "Colon Adenocarcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
...
//            null, indicatorQueryResp.getHighestSensitiveLevel());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", InferredMutation.ONCOGENIC_MUTATIONS.getVariant(), null, null, "Colorectal Cancer", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
        ...
        // query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRD4", InferredMutation.VUS.getVariant(), null, null, null, null, null, null, null, false, null, null);
        // indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
        // assertTrue("The variantExist in the response is not true, but it should.", indicatorQueryResp.getVariantExist() == true);
        ...
        // query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRD4", "VUS", null, null, null, null, null, null, null, false, null, null);
        // indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
        // assertTrue("The variantExist in the response is not true, but it should.", indicatorQueryResp.getVariantExist() == true);

        // Test R2 data
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ALK", "I1171N", null, null, "Lung Adenocarcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "S768_V769delinsIL", null, null, "Non-Small Cell Lung Cancer", MISSENSE_VARIANT, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TMPRSS2-ERG", null, "Fusion", null, "Prostate Adenocarcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("Gene should exist", true, indicatorQueryResp.getGeneExist());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CDKN2A", "M1?", null, null, "Colon Adenocarcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("Gene should exist", true, indicatorQueryResp.getGeneExist());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PDGFRA", "D842Y", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("Gene should exist", true, indicatorQueryResp.getGeneExist());
        assertEquals("The Oncogenicity is not Likely Oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());
...
//        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "A289D", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false, null, null);
//        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
//        assertEquals("The Oncogenicity is not likely neutral, but it should be.", Oncogenicity.LIKELY_NEUTRAL.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "R462I", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not likely neutral, but it should be.", Oncogenicity.LIKELY_NEUTRAL.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "Arg462Ile", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not likely neutral, but it should be.", Oncogenicity.LIKELY_NEUTRAL.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The highest sensitive level of BRAF R462I should be null.", null, indicatorQueryResp.getHighestSensitiveLevel());
        assertEquals("The highest resistance level of BRAF R462I should be null.", null, indicatorQueryResp.getHighestResistanceLevel());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AKT1", "P42I", null, null, "Anaplastic Astrocytoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AKT1", "Pro42Ile", null, null, "Anaplastic Astrocytoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not unknown, but it should be.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The mutation effect is not unknown, but it should be.", MutationEffect.UNKNOWN.getMutationEffect(), indicatorQueryResp.getMutationEffect().getKnownEffect());

        // Check EGFR vIII vII vIV
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "EGFRvIII", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "vIII", null, null, "NSCLC", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The variant summary is not expected.", "The EGFR vIII alteration is known to be oncogenic.", indicatorQueryResp.getVariantSummary());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "vII", null, null, "NSCLC", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "vV", null, null, "NSCLC", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        // Check EGFR CTD
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "CTD", null, null, "NSCLC", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        // Check EGFR KDD
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", null, null, "NSCLC", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR-EGFR", "vIII", "structural_variant", StructuralVariantType.DELETION, "NSCLC", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The variant summary is not expected.", "The EGFR vIII alteration is known to be oncogenic.", indicatorQueryResp.getVariantSummary());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR-EGFR", "vIII", "structural_variant", StructuralVariantType.DELETION, "NSCLC", "", null, null, null, false, null, null);
        ;
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The variant summary is not expected.", "The EGFR vIII alteration is known to be oncogenic.", indicatorQueryResp.getVariantSummary());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "vIII", "structural_variant", StructuralVariantType.DELETION, "NSCLC", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The variant summary is not expected.", "The EGFR vIII alteration is known to be oncogenic.", indicatorQueryResp.getVariantSummary());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ALK", "", "structural_variant", StructuralVariantType.DELETION, "Gastrointestinal Stromal Tumor", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not unknown.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ALK", "", "structural_variant", StructuralVariantType.DELETION, "Gastrointestinal Stromal Tumor", "fusion", null, null, null, false, null, null);
        ;
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not likely oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AKT1", "P68_C77dup", null, null, "Gastrointestinal Stromal Tumor", "In_Frame_Ins", 78, 78, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not Likely Oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The isHotspot is not true, but it should be.", Boolean.TRUE, indicatorQueryResp.getHotspot());
...
//        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "MAP2K1", "N109_R113del", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false, null, null);
//        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
//        assertEquals("The Oncogenicity is not unknown, but it should be.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
//        assertEquals("The isHotspot is true, but it should not be.", Boolean.FALSE, indicatorQueryResp.getHotspot());
//        assertEquals("The highest level of sensitive treatment is not null, but it should be.", null, indicatorQueryResp.getHighestSensitiveLevel());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRCA2", null, "structural_variant", StructuralVariantType.DELETION, "Ovarian Cancer", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "NTRK3", "ETV6-NTRK3", AlterationType.FUSION.label(), null, "Ovarian Cancer", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "NTRK3", "ETV6-NTRK3", "Mutation", null, "Ovarian Cancer", "Fusion", null, null, null, false, null, null);
        ;
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3CA", "C378Y", null, null, null, null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TERT", "Promoter", null, null, "Ovarian Cancer", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not Likely Oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KIT", "", null, null, "Ovarian Cancer", MISSENSE_VARIANT, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not unknown, but it should be.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "X187=", null, null, "CLLSLL", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The Oncogenicity is not unknown, but it should.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertTrue("There highest prognostic level should be empty", indicatorQueryResp.getHighestPrognosticImplicationLevel() == null);

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "X187=", null, null, "CLLSLL", "splice_region_variant", null, null, null, false, null, null);
        ;
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CHEK2", "R111111C", null, null, "Myelodysplastic Workup", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3R1", "W583del", null, null, null, null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KIT", "D820E", null, null, "AMLRUNX1RUNX1T1", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
        assertEquals("The oncogenicity should be 'Resistance'", Oncogenicity.RESISTANCE.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KIT", "Asp820Glu", null, null, "AMLRUNX1RUNX1T1", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
        assertEquals("The oncogenicity should be 'Resistance'", Oncogenicity.RESISTANCE.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The tumor type summary is not expected.",
            "There are no FDA-approved or NCCN-compendium listed treatments specifically for patients with KIT D820E mutant AML with t(8;21)(q22;q22.1);RUNX1-RUNX1T1.", indicatorQueryResp.getTumorTypeSummary());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "Val600Glu", null, null, "MEL", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, false, null, false);
        assertTrue("The data version should not be empty.", StringUtils.isNotEmpty(indicatorQueryResp.getDataVersion()));
        assertEquals("The data version is not expected.", MainUtils.getDataVersion(), indicatorQueryResp.getDataVersion());
        ...
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, false, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, false, null, false);
        ...
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ESR1", null, "structural_variant", StructuralVariantType.DELETION, "Melanoma", null, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, false, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, false, null, false);
        assertTrue("The oncogenicities are not the same, but they should.", resp1.getOncogenic().equals(resp2.getOncogenic()));
        assertTrue("The treatments are not the same, but they should.", resp1.getTreatments().equals(resp2.getTreatments()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 2099, null, null, "structural_variant", StructuralVariantType.DELETION, "Melanoma", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ESR1", null, "structural_variant", StructuralVariantType.DELETION, "Melanoma", null, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, false, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, false, null, false);
        assertTrue("The oncogenicities are not the same, but they should.", resp1.getOncogenic().equals(resp2.getOncogenic()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "CUL1-BRAF Fusion", null, null, "Ovarian Cancer", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CUL1-BRAF", null, "fusion", null, "Ovarian Cancer", null, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, null, "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, null, "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, null, "V600E", null, null, "Melanoma", "", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        assertTrue("Highest sensitive levels are not the same, but they should.", LevelUtils.areSameLevels(resp1.getHighestSensitiveLevel(), resp2.getHighestSensitiveLevel()));
        assertTrue("Highest resistance levels are not the same, but they should.", LevelUtils.areSameLevels(resp1.getHighestResistanceLevel(), resp2.getHighestResistanceLevel()));
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, null, "V600E", null, null, "Melanoma", "missense_mutation", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, "EGFR", "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, "", "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AGK-BRAF", null, AlterationType.STRUCTURAL_VARIANT.name(), null, "Melanoma", "fusion", null, null, null, false, null, null);
        ;
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AGK::BRAF", null, AlterationType.STRUCTURAL_VARIANT.name(), null, "Melanoma", "fusion", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AGK-BRAF", null, null, StructuralVariantType.FUSION, "Melanoma", "fusion", null, null, null, false, null, null);
        ;
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AGK::BRAF", null, null, StructuralVariantType.FUSION, "Melanoma", "fusion", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PRKACA-DNAJB1", null, AlterationType.STRUCTURAL_VARIANT.name(), null, "Melanoma", "fusion", null, null, null, false, null, null);
        ;
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PRKACA::DNAJB1", null, AlterationType.STRUCTURAL_VARIANT.name(), null, "Melanoma", "fusion", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        // Check EGFR CTD
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "EGFR CTD", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "CTD", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false, null, null);
        resp2 = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, null, "MSI-H", null, null, "Colorectal Cancer", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, null, "MSI-H", null, null, "Cervical Endometrioid Carcinoma", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertTrue("The geneExist is not false, but it should be.", indicatorQueryResp.getGeneExist() == false);
        assertEquals("The oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The highest sensitive level is not 1, but it should be.", LevelOfEvidence.LEVEL_1, indicatorQueryResp.getHighestSensitiveLevel());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, null, "TMB-H", null, null, "Colorectal Cancer", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertTrue("The geneExist is not false, but it should be.", indicatorQueryResp.getGeneExist() == false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600L", null, null, "hairy cell leukemia", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        TranscriptSummaryAlterationResult transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.HGVS_G, DEFAULT_REFERENCE_GENOME, hgvsg, false);
        query = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult, hgvsg, false);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.HGVS_G, DEFAULT_REFERENCE_GENOME, hgvsg, false);
        query1 = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult, hgvsg, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF-BRAF", null, "structural_variant", StructuralVariantType.INSERTION, "Ovarian Cancer", "fusion", null, null, null, false, null, null);
        ;
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF-BRAF", null, "structural_variant", StructuralVariantType.INSERTION, "Ovarian Cancer", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KMT2A-MLLT3", null, "structural_variant", StructuralVariantType.TRANSLOCATION, "Acute Myeloid Leukemia", "fusion", null, null, null, false, null, null);
        ;
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KLF5", "P301S", null, null, "Acute Myeloid Leukemia", null, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The oncogenicity is not likely oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());

        // Test for the promoter mutation
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TERT", null, null, null, "Acute Myeloid Leukemia", UPSTREAM_GENE, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertEquals("The oncogenicity is not likely oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());

//        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TERT", null, null, null, "Acute Myeloid Leukemia", FIVE_UTR, null, null, null, null);
//        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
//        assertEquals("The oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TERT", "", null, null, "Acute Myeloid Leukemia", UPSTREAM_GENE, null, null, null, false, null, null);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR-RAD51", null, "fusion", null, "Ovarian Cancer", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR-RAD51", null, "structural_variant", StructuralVariantType.INSERTION, "Ovarian Cancer", "fusion", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KIF5B-MET", null, "structural_variant", StructuralVariantType.DELETION, "Lung Adenocarcinoma", "fusion", null, null, null, false, null, null);
        ;
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KIF5B-MET", "FUSION", "structural_variant", StructuralVariantType.DELETION, "Lung Adenocarcinoma", "fusion", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        pairComparison(resp1, resp2);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BCR-ABL1", null, "structural_variant", StructuralVariantType.DELETION, "Lung Adenocarcinoma", "fusion", null, null, null, false, null, null);
        ;
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ABL1-BCR", null, "structural_variant", StructuralVariantType.DELETION, "Lung Adenocarcinoma", "fusion", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", "structural_variant", StructuralVariantType.DUPLICATION, "NSCLC", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", "structural_variant", StructuralVariantType.DUPLICATION, "NSCLC", "KDD", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        pairComparison(resp1, resp2);

        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", null, null, "NSCLC", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", "structural_variant", StructuralVariantType.DUPLICATION, "NSCLC", "fusion", null, null, null, false, null, null);
        ;
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        pairComparison(resp1, resp2);
        ...
        // query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "MAP2K1", "C121S", null, null, "RDD", null, null, null, null, false, null, null);
        // query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "MAP2K1", "C121S", null, null, "Histiocytosis", null, null, null, null, false, null, null);
        // resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        // resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        // pairComparison(resp1, resp2);

        // Test positional variant but with a missense variant consequence
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "R248", null, null, "RDD", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "R248", null, null, "RDD", MISSENSE_VARIANT, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        pairComparison(resp1, resp2);

        // Test using official hugo symbol and gene alias
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ABL1", "D276G", null, null, "MEL", null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "c-ABL", "D276G", null, null, "MEL", MISSENSE_VARIANT, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
        pairComparison(resp1, resp2, true);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KRAS", "G12C", null, null, null, null, null, null, null, false, null, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KRAS", "G12C", null, null, "NSCLC", MISSENSE_VARIANT, null, null, null, false, null, null);
        resp1 = IndicatorUtils.processQuerySomatic(query1, null, true, null, false);
        resp2 = IndicatorUtils.processQuerySomatic(query2, null, true, null, false);
    ...
    public void testProcessQueryWithGenomicChange() throws Exception {
        String hgvsg = "7:g.140453136A>T";
        TranscriptSummaryAlterationResult transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.HGVS_G, DEFAULT_REFERENCE_GENOME, hgvsg, false);
        Query query = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult, hgvsg, false);
        SomaticIndicatorQueryResp indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertTrue("The geneExist is not true, but it should be.", indicatorQueryResp.getGeneExist() == true);
        assertEquals("The oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The highest sensitive level is not 1, but it should be.", LevelOfEvidence.LEVEL_1, indicatorQueryResp.getHighestSensitiveLevel());
        ...
        hgvsg = "7:g.140453136A>T";
        transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.HGVS_G, DEFAULT_REFERENCE_GENOME, hgvsg, false);
        Query query1 = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult, hgvsg, false);
        ...
        SomaticIndicatorQueryResp resp1 = IndicatorUtils.processQuerySomatic(query1, null, false, null, false);
        ...
        TranscriptSummaryAlterationResult transcriptSummaryAlterationResult1 = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.HGVS_G, DEFAULT_REFERENCE_GENOME, hgvsg1, false);
        TranscriptSummaryAlterationResult transcriptSummaryAlterationResult2 = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.HGVS_G, DEFAULT_REFERENCE_GENOME, hgvsg2, false);
        query1 = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult1, hgvsg1, false);
        query2 = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult2, hgvsg2, false);
        ...
        transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.GENOMIC_LOCATION, DEFAULT_REFERENCE_GENOME, genomicLocation, false);
        query = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult, genomicLocation, false);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertTrue("The geneExist is not true, but it should be.", indicatorQueryResp.getGeneExist() == true);
        assertEquals("The oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The highest sensitive level is not 1, but it should be.", LevelOfEvidence.LEVEL_1, indicatorQueryResp.getHighestSensitiveLevel());
        ...
        transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.GENOMIC_LOCATION, DEFAULT_REFERENCE_GENOME, hgvsg, false);
        query = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult, hgvsg, false);
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
        assertTrue("The geneExist is not false, but it should be.", indicatorQueryResp.getGeneExist() == false);
        assertEquals("The oncogenicity is not Unknown, but it should be.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.GENOMIC_LOCATION, DEFAULT_REFERENCE_GENOME, genomicLocation, false);
        query1 = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult, genomicLocation, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false, null, null);
        ...
        transcriptSummaryAlterationResult1 = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.GENOMIC_LOCATION, DEFAULT_REFERENCE_GENOME, genomicLocation1, false);
        transcriptSummaryAlterationResult2 = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.GENOMIC_LOCATION, DEFAULT_REFERENCE_GENOME, genomicLocation2, false);
        query1 = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult1, genomicLocation1, false);
        query2 = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Melanoma", transcriptSummaryAlterationResult2, genomicLocation2, false);
        ...
        transcriptSummaryAlterationResult1 = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.GENOMIC_LOCATION, DEFAULT_REFERENCE_GENOME, genomicLocation, false);
        ...
        List<TranscriptSummaryAlterationResult> map = AlterationUtils.getAlterationsFromGenomeNexus(annotations, DEFAULT_REFERENCE_GENOME, false);
    ...
    @Test
    public void testProcessQueryWithGenomicLocationForGermline() throws ApiException {
        // This is a curated variant
        String hgvsg = "17:g.41246044_41246048del";
        TranscriptSummaryAlterationResult transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.HGVS_G, DEFAULT_REFERENCE_GENOME, hgvsg, true);
        Query query = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "Breast Cancer", transcriptSummaryAlterationResult, hgvsg, true);
        GermlineIndicatorQueryResp indicatorQueryResp = IndicatorUtils.processQueryGermline(query, null, false, null, false);
        assertTrue("The geneExist is not true, but it should be.", indicatorQueryResp.getGeneExist() == true);
        assertTrue("The variantExist is not true, but it should be", indicatorQueryResp.getVariantExist() == true);
        assertEquals("The pathogenicity is not Pathogenic, but it should be.", Pathogenicity.YES.getPathogenic(), indicatorQueryResp.getPathogenic());
        assertEquals("The highest sensitive level is not 1, but it should be.", LevelOfEvidence.LEVEL_1, indicatorQueryResp.getHighestSensitiveLevel());
        assertEquals("The resolved query alteration should be c.1504_1508del", "c.1504_1508del", indicatorQueryResp.getQuery().getAlteration());

        // We have c.460C>T curated for ERCC3, but the query is for IL74. Make sure we don't pick up another gene's variant.
        hgvsg = "5:g.35871238C>T";
        transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.HGVS_G, DEFAULT_REFERENCE_GENOME, hgvsg, true);
        query = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "", transcriptSummaryAlterationResult, hgvsg, true);
        indicatorQueryResp = IndicatorUtils.processQueryGermline(query, null, false, null, false);
        assertEquals("The resolved query hugo symbol should be IL7R", "IL7R", indicatorQueryResp.getQuery().getHugoSymbol());
        assertEquals("The resolved query alteration should be c.460C>T", "c.460C>T", indicatorQueryResp.getQuery().getAlteration());
        assertTrue("The variantExist is not false, but it should be", indicatorQueryResp.getVariantExist() == false);

        // Make sure we resolved the query alteration correctly even if the variant does not exist
        hgvsg = "17:g.41209136C>A";
        transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.HGVS_G, DEFAULT_REFERENCE_GENOME, hgvsg, true);
        query = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "", transcriptSummaryAlterationResult, hgvsg, true);
        indicatorQueryResp = IndicatorUtils.processQueryGermline(query, null, false, null, false);
        assertTrue("The geneExist is not true, but it should be.", indicatorQueryResp.getGeneExist() == true);
        assertTrue("The variantExist is not false, but it should be", indicatorQueryResp.getVariantExist() == false);
        assertEquals("The resolved query alteration should be c.5210G>T", "c.5210G>T", indicatorQueryResp.getQuery().getAlteration());

        // This is a curated variant but with a different format of genomic location. Make sure it can be resolved and annotated correctly.
        String genomicLocation = "17,41258545,41258545,C,A";
        transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.GENOMIC_LOCATION, DEFAULT_REFERENCE_GENOME, genomicLocation, true);
        query = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "", transcriptSummaryAlterationResult, genomicLocation, true);
        indicatorQueryResp = IndicatorUtils.processQueryGermline(query, null, false, null, false);
        assertTrue("The geneExist is not true, but it should be.", indicatorQueryResp.getGeneExist() == true);
        assertTrue("The variantExist is not true, but it should be", indicatorQueryResp.getVariantExist() == true);
        assertEquals("The pathogenicity is not Likely Pathogenic, but it should be.", Pathogenicity.LIKELY.getPathogenic(), indicatorQueryResp.getPathogenic());
        assertEquals("The highest sensitive level is not 1, but it should be.", LevelOfEvidence.LEVEL_1, indicatorQueryResp.getHighestSensitiveLevel());
        assertEquals("The resolved query alteration should be c.140G>T", "c.140G>T", indicatorQueryResp.getQuery().getAlteration());

        // We have c.460C>T curated for ERCC3, but the query is for IL74. Make sure we don't pick up another gene's variant even if the query is in genomic location format.
        genomicLocation = "5,35871238,35871238,C,T";
        transcriptSummaryAlterationResult = AlterationUtils.getAlterationFromGenomeNexus(GNVariantAnnotationType.GENOMIC_LOCATION, DEFAULT_REFERENCE_GENOME, genomicLocation, true);
        query = QueryUtils.getQueryFromAlteration(DEFAULT_REFERENCE_GENOME, "", transcriptSummaryAlterationResult, genomicLocation, true);
        indicatorQueryResp = IndicatorUtils.processQueryGermline(query, null, false, null, false);
        assertTrue("The geneExist is not true, but it should be.", indicatorQueryResp.getGeneExist() == true);
    ...
    public void testProcessQueryForGermline() {
        ...
        SomaticIndicatorQueryResp somaticIndicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, false);
    ...
    public void testProcessQueryWhenAltIsEmpty() {
        Query queryWithOnlyGene = new Query(null, DEFAULT_REFERENCE_GENOME, null, "FGFR3", "", null, null, "", null, null, null, null, false, null, null);
        shouldNotHaveClinicalImplication(IndicatorUtils.processQuerySomatic(queryWithOnlyGene, null, true, null, false));
        queryWithOnlyGene = new Query(null, DEFAULT_REFERENCE_GENOME, null, "FGFR3", null, null, null, "", null, null, null, null, false, null, null);
        shouldNotHaveClinicalImplication(IndicatorUtils.processQuerySomatic(queryWithOnlyGene, null, true, null, false));

        Query queryWithCC = new Query(null, DEFAULT_REFERENCE_GENOME, null, "FGFR3", "", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false, null, null);
        shouldNotHaveClinicalImplication(IndicatorUtils.processQuerySomatic(queryWithCC, null, true, null, false));
        queryWithCC = new Query(null, DEFAULT_REFERENCE_GENOME, null, "FGFR3", null, null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false, null, null);
        shouldNotHaveClinicalImplication(IndicatorUtils.processQuerySomatic(queryWithCC, null, true, null, false));

        Query queryWithConsequence = new Query(null, DEFAULT_REFERENCE_GENOME, null, "FGFR3", "", null, null, "", "3_prime_UTR_variant", null, null, null, false, null, null);
        ;
        shouldNotHaveClinicalImplication(IndicatorUtils.processQuerySomatic(queryWithConsequence, null, true, null, false));
        queryWithConsequence = new Query(null, DEFAULT_REFERENCE_GENOME, null, "FGFR3", null, null, null, "", "3_prime_UTR_variant", null, null, null, false, null, null);
        ;
        shouldNotHaveClinicalImplication(IndicatorUtils.processQuerySomatic(queryWithConsequence, null, true, null, false));
    }
    ...
    public void testProcessQueryGeneOnlyQuery() {
        ...
        SomaticIndicatorQueryResp indicatorQueryRespGeneOnly = IndicatorUtils.processQuerySomatic(queryWithAlt, null, true, null, true);
        SomaticIndicatorQueryResp indicatorQueryResp = IndicatorUtils.processQuerySomatic(queryWithAlt, null, true, null, false);
        ...
        Query query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "", null, null, null, null, null, null, null, false, null, null);
        /// geneQueryOnly is true, should return clinical implications info under the gene
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, true);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", null, null, null, null, null, null, null, null, false, null, null);
        /// geneQueryOnly is true, should return clinical implications info under the gene
        indicatorQueryResp = IndicatorUtils.processQuerySomatic(query, null, true, null, true);
        assertTrue("The geneExist in the response is not true, but it should be.", indicatorQueryResp.getGeneExist() == true);
        assertTrue("The variantSummary is not empty, but it should be.", StringUtils.isEmpty(indicatorQueryResp.getVariantSummary()));
