...
public class IndicatorUtilsTest {
    ...
    public void testProcessQuery() throws Exception {
        ...
        // Gene not exists
        Query query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TEST", "V123M", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CCT8L2-CCT8L2", null, "structural_variant", StructuralVariantType.DELETION, "Pancreatic Adenocarcinoma", null, null, null, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CCT8L2-CCT8L2", null, "structural_variant", StructuralVariantType.DELETION, "Pancreatic Adenocarcinoma", "fusion", null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("Gene should not exist, but it does.", false, indicatorQueryResp.getGeneExist());
        assertEquals("The oncogenicity is not unknown, but it should.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertTrue("There is treatment(s) in the response, but it should not have any.", indicatorQueryResp.getTreatments().size() == 0);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "MSH2", "", null, null, "CANCER", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The oncogenicity is not unknown, but it should.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());

        // Oncogenic should always match with oncogenic summary, similar to likely oncogenic
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "R248Q", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KRAS", "V14I", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        // Check critical case
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        // Check fusion.
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "CUL1-BRAF Fusion", null, null, "Ovarian Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF-TMPRSS2", null, "fusion", null, "Prostate Adenocarcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ATM", "ATM-intragenic", null, null, "Ovarian Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "MEL", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        // check variant exist
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, null, null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertTrue("The variantExist should be true, but it's not", indicatorQueryResp.getVariantExist());
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3CA", "V105_R108delVGNR", null, null, null, null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertTrue("The variantExist should be true, but it's not", indicatorQueryResp.getVariantExist());
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3CA", "V105_R108del", null, null, null, null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertTrue("The variantExist should be true, but it's not", indicatorQueryResp.getVariantExist());
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3CA", "V10000", null, null, null, null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
...
//        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "RET", "Fusions", null, null, "Medullary Thyroid Cancer", null, null, null, null, false);
//        indicatorQueryResp = IndicatorUtils.processQuery(query, null true, null);
...
//        assertEquals("The level 3A should be shown before 2A", LevelOfEvidence.LEVEL_3A, indicatorQueryResp.getTreatments().get(0).getLevel());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3R1", "K567E", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KEAP1", "Y525S", null, null, "Pancreatic Adenocarcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ALK", "R401Q", null, null, "Colon Adenocarcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
...
//            null, indicatorQueryResp.getHighestSensitiveLevel());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KRAS", "Q61K", null, null, "Colorectal Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
        assertEquals("The oncogenicity should be 'Likely Oncogenic'", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", InferredMutation.ONCOGENIC_MUTATIONS.getVariant(), null, null, "Colorectal Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
        ...
        // query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRD4", InferredMutation.VUS.getVariant(), null, null, null, null, null, null, null, false);
        // indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
        // assertTrue("The variantExist in the response is not true, but it should.", indicatorQueryResp.getVariantExist() == true);
        ...
        // query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRD4", "VUS", null, null, null, null, null, null, null, false);
        // indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
        // assertTrue("The variantExist in the response is not true, but it should.", indicatorQueryResp.getVariantExist() == true);

        // Test R2 data
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ALK", "I1171N", null, null, "Lung Adenocarcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "S768_V769delinsIL", null, null, "Non-Small Cell Lung Cancer", MISSENSE_VARIANT, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TMPRSS2-ERG", null, "Fusion", null, "Prostate Adenocarcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("Gene should exist", true, indicatorQueryResp.getGeneExist());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CDKN2A", "M1?", null, null, "Colon Adenocarcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("Gene should exist", true, indicatorQueryResp.getGeneExist());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PDGFRA", "D842Y", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("Gene should exist", true, indicatorQueryResp.getGeneExist());
        assertEquals("The Oncogenicity is not Likely Oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());
...
//        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "A289D", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false);
//        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
//        assertEquals("The Oncogenicity is not likely neutral, but it should be.", Oncogenicity.LIKELY_NEUTRAL.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "R462I", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not likely neutral, but it should be.", Oncogenicity.LIKELY_NEUTRAL.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AKT1", "P42I", null, null, "Anaplastic Astrocytoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "EGFRvIII", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "vIII", null, null, "NSCLC", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The variant summary is not expected.", "The EGFR vIII alteration is known to be oncogenic.", indicatorQueryResp.getVariantSummary());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "vII", null, null, "NSCLC", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "vV", null, null, "NSCLC", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        // Check EGFR CTD
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "CTD", null, null, "NSCLC", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        // Check EGFR KDD
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", null, null, "NSCLC", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", "structural_variant", StructuralVariantType.DELETION, "NSCLC", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The variant summary is not expected.", "The EGFR kinase domain duplication (KDD) is known to be oncogenic.", indicatorQueryResp.getVariantSummary());
        assertEquals("The highest sensitive level should be 1", LevelOfEvidence.LEVEL_3A, indicatorQueryResp.getHighestSensitiveLevel());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "kinase domain duplication", null, null, "NSCLC", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        // Check FLT3 ITD
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "FLT3", "ITD", null, null, "AML", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR-EGFR", "vIII", "structural_variant", StructuralVariantType.DELETION, "NSCLC", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The variant summary is not expected.", "The EGFR vIII alteration is known to be oncogenic.", indicatorQueryResp.getVariantSummary());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR-EGFR", "vIII", "structural_variant", StructuralVariantType.DELETION, "NSCLC", "", null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The variant summary is not expected.", "The EGFR vIII alteration is known to be oncogenic.", indicatorQueryResp.getVariantSummary());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "vIII", "structural_variant", StructuralVariantType.DELETION, "NSCLC", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The variant summary is not expected.", "The EGFR vIII alteration is known to be oncogenic.", indicatorQueryResp.getVariantSummary());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ALK", "", "structural_variant", StructuralVariantType.DELETION, "Gastrointestinal Stromal Tumor", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not unknown.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ALK", "", "structural_variant", StructuralVariantType.DELETION, "Gastrointestinal Stromal Tumor", "fusion", null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not likely oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AKT1", "P68_C77dup", null, null, "Gastrointestinal Stromal Tumor", "In_Frame_Ins", 78, 78, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not Likely Oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The isHotspot is not true, but it should be.", Boolean.TRUE, indicatorQueryResp.getHotspot());
...
//        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "MAP2K1", "N109_R113del", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false);
//        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
//        assertEquals("The Oncogenicity is not unknown, but it should be.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
//        assertEquals("The isHotspot is true, but it should not be.", Boolean.FALSE, indicatorQueryResp.getHotspot());
//        assertEquals("The highest level of sensitive treatment is not null, but it should be.", null, indicatorQueryResp.getHighestSensitiveLevel());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRCA2", null, "structural_variant", StructuralVariantType.DELETION, "Ovarian Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "NTRK3", "ETV6-NTRK3", AlterationType.FUSION.label(), null, "Ovarian Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "NTRK3", "ETV6-NTRK3", "Mutation", null, "Ovarian Cancer", "Fusion", null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3CA", "C378Y", null, null, null, null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TERT", "Promoter", null, null, "Ovarian Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not Likely Oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KIT", "", null, null, "Ovarian Cancer", MISSENSE_VARIANT, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not unknown, but it should be.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "X187=", null, null, "CLLSLL", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The Oncogenicity is not unknown, but it should.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertTrue("There highest prognostic level should be empty", indicatorQueryResp.getHighestPrognosticImplicationLevel() == null);

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "X187=", null, null, "CLLSLL", "splice_region_variant", null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CHEK2", "R111111C", null, null, "Myelodysplastic Workup", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PIK3R1", "W583del", null, null, null, null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "C797S", null, null, "Lung Adenocarcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KIT", "D820E", null, null, "AMLRUNX1RUNX1T1", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, false, null);
        assertEquals("The oncogenicity should be 'Resistance'", Oncogenicity.RESISTANCE.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ESR1", null, "structural_variant", StructuralVariantType.DELETION, "Melanoma", null, null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, false, null);
        resp2 = IndicatorUtils.processQuery(query2, null, false, null);
        assertTrue("The oncogenicities are not the same, but they should.", resp1.getOncogenic().equals(resp2.getOncogenic()));
        assertTrue("The treatments are not the same, but they should.", resp1.getTreatments().equals(resp2.getTreatments()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 2099, null, null, "structural_variant", StructuralVariantType.DELETION, "Melanoma", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ESR1", null, "structural_variant", StructuralVariantType.DELETION, "Melanoma", null, null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, false, null);
        resp2 = IndicatorUtils.processQuery(query2, null, false, null);
        assertTrue("The oncogenicities are not the same, but they should.", resp1.getOncogenic().equals(resp2.getOncogenic()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "CUL1-BRAF Fusion", null, null, "Ovarian Cancer", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "CUL1-BRAF", null, "fusion", null, "Ovarian Cancer", null, null, null, null, false);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, null, "V600E", null, null, "Melanoma", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, null, "V600E", null, null, "Melanoma", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, null, "V600E", null, null, "Melanoma", "", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        assertTrue("Oncogenicities are not the same, but they should.", resp1.getOncogenic().equals(resp2.getOncogenic()));
        ...
        assertTrue("Highest sensitive levels are not the same, but they should.", LevelUtils.areSameLevels(resp1.getHighestSensitiveLevel(), resp2.getHighestSensitiveLevel()));
        assertTrue("Highest resistance levels are not the same, but they should.", LevelUtils.areSameLevels(resp1.getHighestResistanceLevel(), resp2.getHighestResistanceLevel()));
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, null, "V600E", null, null, "Melanoma", "missense_mutation", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        assertTrue("Oncogenicities are not the same, but they should.", resp1.getOncogenic().equals(resp2.getOncogenic()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, "EGFR", "V600E", null, null, "Melanoma", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, 673, "", "V600E", null, null, "Melanoma", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600E", null, null, "Melanoma", null, null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AGK-BRAF", null, AlterationType.STRUCTURAL_VARIANT.name(), null, "Melanoma", "fusion", null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AGK::BRAF", null, AlterationType.STRUCTURAL_VARIANT.name(), null, "Melanoma", "fusion", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        assertTrue("Oncogenicities are not the same, but they should.", resp1.getOncogenic().equals(resp2.getOncogenic()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AGK-BRAF", null, null, StructuralVariantType.FUSION, "Melanoma", "fusion", null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "AGK::BRAF", null, null, StructuralVariantType.FUSION, "Melanoma", "fusion", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        assertTrue("Oncogenicities are not the same, but they should.", resp1.getOncogenic().equals(resp2.getOncogenic()));
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PRKACA-DNAJB1", null, AlterationType.STRUCTURAL_VARIANT.name(), null, "Melanoma", "fusion", null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "PRKACA::DNAJB1", null, AlterationType.STRUCTURAL_VARIANT.name(), null, "Melanoma", "fusion", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        assertTrue("Genes are not the same, but they should.", resp1.getGeneSummary().equals(resp2.getGeneSummary()));
        assertTrue("Oncogenicities are not the same, but they should.", resp1.getOncogenic().equals(resp2.getOncogenic()));
        ...
        // Check EGFR CTD
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "EGFR CTD", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query, null, true, null);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "CTD", null, null, "Gastrointestinal Stromal Tumor", null, null, null, null, false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, null, "MSI-H", null, null, "Colorectal Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, null, "MSI-H", null, null, "Cervical Endometrioid Carcinoma", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertTrue("The geneExist is not false, but it should be.", indicatorQueryResp.getGeneExist() == false);
        assertEquals("The oncogenicity is not Oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The highest sensitive level is not 1, but it should be.", LevelOfEvidence.LEVEL_1, indicatorQueryResp.getHighestSensitiveLevel());
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, null, "TMB-H", null, null, "Colorectal Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertTrue("The geneExist is not false, but it should be.", indicatorQueryResp.getGeneExist() == false);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF", "V600L", null, null, "hairy cell leukemia", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF-BRAF", null, "structural_variant", StructuralVariantType.INSERTION, "Ovarian Cancer", "fusion", null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BRAF-BRAF", null, "structural_variant", StructuralVariantType.INSERTION, "Ovarian Cancer", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KMT2A-MLLT3", null, "structural_variant", StructuralVariantType.TRANSLOCATION, "Acute Myeloid Leukemia", "fusion", null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KLF5", "P301S", null, null, "Acute Myeloid Leukemia", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The oncogenicity is not likely oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());

        // Test for the promoter mutation
        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TERT", null, null, null, "Acute Myeloid Leukemia", UPSTREAM_GENE, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The oncogenicity is not likely oncogenic, but it should be.", Oncogenicity.LIKELY.getOncogenic(), indicatorQueryResp.getOncogenic());

//        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TERT", null, null, null, "Acute Myeloid Leukemia", FIVE_UTR, null, null, null, false);
//        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
//        assertEquals("The oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());

        query = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TERT", "", null, null, "Acute Myeloid Leukemia", UPSTREAM_GENE, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        ...
        query = new Query(null, ReferenceGenome.GRCh37, null, "MYD88", "M232T", null, null, "Acute Myeloid Leukemia", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The oncogenicity is not oncogenic, but it should be.", Oncogenicity.YES.getOncogenic(), indicatorQueryResp.getOncogenic());
        ...
        query = new Query(null, ReferenceGenome.GRCh38, null, "MYD88", "M232T", null, null, "Acute Myeloid Leukemia", null, null, null, null, false);
        indicatorQueryResp = IndicatorUtils.processQuery(query, null, true, null);
        assertEquals("The oncogenicity is not unknown, but it should be.", Oncogenicity.UNKNOWN.getOncogenic(), indicatorQueryResp.getOncogenic());
        assertEquals("The mutation effect is not unknown, but it should be.", MutationEffect.UNKNOWN.getMutationEffect(), indicatorQueryResp.getMutationEffect().getKnownEffect());
        assertTrue("The mutation is not hotspot, but it should be.", !indicatorQueryResp.getHotspot());
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR-RAD51", null, "fusion", null, "Ovarian Cancer", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR-RAD51", null, "structural_variant", StructuralVariantType.INSERTION, "Ovarian Cancer", "fusion", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KIF5B-MET", null, "structural_variant", StructuralVariantType.DELETION, "Lung Adenocarcinoma", "fusion", null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KIF5B-MET", "FUSION", "structural_variant", StructuralVariantType.DELETION, "Lung Adenocarcinoma", "fusion", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        pairComparison(resp1, resp2);

        // When queried gene order is different, but one of the combinations exists, then the variantExist should be set to true
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "BCR-ABL1", null, "structural_variant", StructuralVariantType.DELETION, "Lung Adenocarcinoma", "fusion", null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ABL1-BCR", null, "structural_variant", StructuralVariantType.DELETION, "Lung Adenocarcinoma", "fusion", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        pairComparison(resp1, resp2, true);

        // handle mixed input for structural variant deletion
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", "structural_variant", StructuralVariantType.DUPLICATION, "NSCLC", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", "structural_variant", StructuralVariantType.DUPLICATION, "NSCLC", "KDD", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        pairComparison(resp1, resp2);

        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", null, null, "NSCLC", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "EGFR", "KDD", "structural_variant", StructuralVariantType.DUPLICATION, "NSCLC", "fusion", null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        pairComparison(resp1, resp2);
        ...
        // query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "MAP2K1", "C121S", null, null, "RDD", null, null, null, null, false);
        // query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "MAP2K1", "C121S", null, null, "Histiocytosis", null, null, null, null, false);
        // resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        // resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        // pairComparison(resp1, resp2);

        // Test positional variant but with a missense variant consequence
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "R248", null, null, "RDD", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "TP53", "R248", null, null, "RDD", MISSENSE_VARIANT, null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        pairComparison(resp1, resp2);

        // Test using official hugo symbol and gene alias
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "ABL1", "D276G", null, null, "MEL", null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "c-ABL", "D276G", null, null, "MEL", MISSENSE_VARIANT, null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
        pairComparison(resp1, resp2, true);
        ...
        query1 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KRAS", "G12C", null, null, null, null, null, null, null, false);
        query2 = new Query(null, DEFAULT_REFERENCE_GENOME, null, "KRAS", "G12C", null, null, "NSCLC", MISSENSE_VARIANT, null, null, null, false);
        resp1 = IndicatorUtils.processQuery(query1, null, true, null);
        resp2 = IndicatorUtils.processQuery(query2, null, true, null);
