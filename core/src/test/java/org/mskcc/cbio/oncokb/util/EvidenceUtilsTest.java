...
public class EvidenceUtilsTest extends TestCase {
    ...
    public void testProcessRequest() {
        ...
        List<EvidenceQueryRes> responses = EvidenceUtils.processRequest(Collections.singletonList(query), null, Collections.singleton(LevelOfEvidence.LEVEL_1), true, false, Optional.empty());
        ...
        query = new Query();
        responses = EvidenceUtils.processRequest(Collections.singletonList(query), Collections.singleton(EvidenceType.GENE_SUMMARY), null, true, false, Optional.empty());
        processRequestSuite(responses);
        ...
        query = new Query();
        responses = EvidenceUtils.processRequest(Collections.singletonList(query), Collections.singleton(EvidenceType.MUTATION_EFFECT), null, true, false, Optional.empty());
        processRequestSuite(responses);
        ...
        query = new Query();
        responses = EvidenceUtils.processRequest(Collections.singletonList(query), Collections.singleton(EvidenceType.TUMOR_TYPE_SUMMARY), null, true, false, Optional.empty());
        processRequestSuite(responses);
        ...
        query = new Query();
        responses = EvidenceUtils.processRequest(Collections.singletonList(query), EvidenceTypeUtils.getSensitiveTreatmentEvidenceTypes(), null, true, false, Optional.empty());
        processRequestSuite(responses);
        ...
        responses = EvidenceUtils.processRequest(Collections.singletonList(query), null, null, true, false, Optional.empty());
        processRequestSuite(responses);
