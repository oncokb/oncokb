...
public class OpenStreetMapUtilsTest extends TestCase{
    public void testOpenStreetMapUtils() throws Exception{
        ...
        Coordinates coord1 = OpenStreetMapUtils.getInstance().getCoordinates(address1);
        ...
        Coordinates coord2 = OpenStreetMapUtils.getInstance().getCoordinates(address2);
        ...
        double dis1 = OpenStreetMapUtils.getInstance().calculateDistance(coord1, coord2);
        assertEquals("Get distance between two coordinates has error", exp3, dis1);
    }
}
